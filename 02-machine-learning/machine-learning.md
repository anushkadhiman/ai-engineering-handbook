...
### ZeRO (Zero Redundancy Optimizer) ZeRO (used in DeepSpeed or PyTorch FSDP) is a powerful, modern technique that shards model states, gradients, and optimizer states across GPUs, rather than replicating them.
...
### Pipeline Parallelism (PP) Pipeline Parallelism divides the model's layers sequentially across different GPUs.
